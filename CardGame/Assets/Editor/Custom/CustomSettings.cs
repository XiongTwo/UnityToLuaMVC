...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(StaticModules.ResourceManage)),
        _GT(typeof(StaticModules.UpdateController)),
        _GT(typeof(StaticModules.SqliteDbManage)),
        _GT(typeof(SqliteDbHelper)),
        _GT(typeof(Mono.Data.Sqlite.SqliteDataReader)),
